...
* Forecast Trajectory Neighbors (FTN): A meta-learning strategy that can be integrated with any forecasting model. FTN works by using training observations to correct errors in multi-step predictions through nearest neighbor matching of forecast trajectories [1]_.
